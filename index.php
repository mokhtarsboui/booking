...
<body>
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Welcome To<br>Our Restaurant</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Getting Served by the best is a garantie!</p>
                            <a href="login.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book A Table</a>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Our Crew</h5>
                                <p>Our Crew is composed by qualified people who love their job</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Quality Food</h5>
                                <p>Here Getting the best quality is a must and garanted      </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-xxl py-5">
			...
			<h3 align="center">Enjoy Tasty Meals With Affordable Prices</a></h3><br />
			<br />
			<div class="row">
