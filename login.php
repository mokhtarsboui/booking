        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Welcome Abroad!</h1>
                </div>
                <!-- <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form class="loginform" action="sendLogininfo.php" method="POST">
                                <div class="">
                                    <h5 class="section-title ff-secondary fw-normal text-primary bkngtobe">Username</h5>
                                </div>
                            ...
                            <div class="div-for-a"><a href="Register.php">Don't have account?register now </a></div> 
                        </div>
                    </div>
                </div>
            </div>
